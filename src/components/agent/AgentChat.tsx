        ...
        <>
            ...
            {!isOpen && (
                <button
                    ...
                    className="fixed bottom-4 right-2 md:bottom-4 md:right-2 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-all hover:scale-110 hover:opacity-90"
