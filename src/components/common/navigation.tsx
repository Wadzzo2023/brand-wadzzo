...
import { Map, FileText, Target, Gift, BarChart3, Bell, Settings, LogOut, Store, User } from "lucide-react"
...
function LogOutButton() {
    ...
    return (
        <div className="flex items-center justify-start gap-3 p-3 w-full rounded-lg hover:bg-accent/50 transition-colors group/logout">
            ...
            {/*  User info appears on hover with perfect timing */}
            ...
            {/*  Logout button appears on hover with smooth animation */}
            <Button
